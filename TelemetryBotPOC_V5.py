    ...
    try:
        ...
        # Convert to dictionary, removing only None values
            ...
            for item in inter_res:
                ...
                entry = f"Platform: {platform} \n \n SubWorkLoadScenario: {sub_workload_scenario}\n"
...
def Recommendation_response(user_question):
    try:
        ...
        for section in json_sections:
            ...
            filtered_string = json.dumps(filtered_data, indent=4)
    ...
    try:
        ...
        **Instructions**: 
        Understand the user question and category the user prompt or question into either of the below two categories -
            ...
            3. Recommendation : If the user prompts are related to suggest or recommend, categorize them into the "Recommendation" category
            ...
            4. others : If the user prompts is not related to any of the above 3 category and is a generic question not related to telemetry or subworkloadscenario or recommendations of telemetries in any case categorize it into "others".
            Example questions - WHat is an apple?
                                Tell about Lewis hamilton
                                Tell about armstrong 
                                What is earth
...
def main():
    try:
        ...
        col1, col2, col3 = st.columns([1, 1.85, 0.4])
      
        # Display logo on the left
        with col1:
            st.image("musigma.png", width=80) # Adjust width as needed
        ...
        with col3:
            st.image("microsoft_PNG13.png", width=70)  # Align the logo to the right
            ...
            if flag == "Subworkloadscenario":
                ...
                with st.chat_message("assistant"):
                    ...
                    if output.startswith('Please'):
                        ...
                        st.code(output)
                        st.session_state.messages.append({"role": "assistant", "type": "code", "content": output})
